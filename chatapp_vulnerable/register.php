...
if(isset($_POST["register"]))
{
    ...
    else
    {
        if($user_object->save_data())
        {
            ...
            $success_message = 'Verification Email sent to ' . $_POST["user_email"] . ', so before login first verify your email';
        }
        else
        {
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" id="register_form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="user_password" id="user_password" class="form-control" data-parsley-minlength="8" data-parsley-maxlength="20" data-parsley-pattern="^[a-zA-Z0-9]+$" required />
                            </div>
